...
social_failures = [
    "Your charisma just filed for bankruptcy.",
    "Is that a tumbleweed rolling through your social skills?",
    "You’ve unlocked the 'Awkward Silence' achievement—gold tier!",
    "That wasn’t just a miss, it was a critical fumble on personality.",
    "You’re one more bad joke away from becoming a meme.",
    "Congratulations, you’ve set the record for shortest conversation ever.",
    "Even your shadow just facepalmed at that one.",
    "The only thing you’re charming is the furniture—well done!",
    "Somewhere out there, a sociability coach is crying.",
    "You brought a knife to a gunfight... but it’s plastic.",
    "That wasn’t an icebreaker; it was a Titanic-level disaster.",
    "Your words were so sharp, they cut the vibe clean in half.",
    "You’ve achieved a perfect zero in emotional intelligence—flawless victory!",
    "Whatever you were aiming for, you missed... spectacularly.",
    "Not even the Force could have saved you from that interaction.",
    "You didn’t just drop the ball; you kicked it into another dimension.",
    "Your attempt at a connection got auto-rejected by the universe.",
    "That’s not a bridge you burned—it’s the whole city block.",
    "You’re now officially banned from small talk for life.",
    "Your social license just got revoked—better luck next century!",
